...
/*******************************************************************************
 * Return Codes defined by this software.
 ******************************************************************************/
// clang-format off
enum ReturnCode {
    ...
    ERROR31__FREQUENCY = 3100, /**< Frequency must be between 0.3 and 3 GHz */
    ...
    ERROR32__FREQUENCY = 3200, /**< Frequency must be between 2 and 67 GHz */
    ...
    ERROR33__FREQUENCY = 3300, /**< Frequency must be between 10 and 100 GHz */
