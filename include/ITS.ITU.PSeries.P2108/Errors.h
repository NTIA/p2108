...
#define ERROR31__FREQUENCY                                                     \
    3100 /**< Frequency must be between 0.3 and 3 GHz, inclusive */
#define ERROR31__ANTENNA_HEIGHT                                                \
    3101 /**< Antenna height must be @f$ \geq @f$ 0 meters */
#define ERROR31__STREET_WIDTH                                                  \
    3102 /**< Street width must be @f$ > @f$ 0 meters */
#define ERROR31__CLUTTER_HEIGHT                                                \
    3103 /**< Representative clutter height must be @f$ > @f$ 0 meters */
#define ERROR31__CLUTTER_TYPE 3104 /**< Invalid value for clutter type */

////////////////////////////////////////////////////////////////////////////////
// Section 3.2 Error Codes
#define ERROR32__FREQUENCY                                                     \
    3200 /**< Frequency must be between 2 and 67 GHz, inclusive */
#define ERROR32__DISTANCE                                                      \
    3201 /**< Path distance must be @f$ \geq @f$ 0.25 km */
#define ERROR32__PERCENTAGE 3202 /**< Percentage must be between 0 and 100 */

////////////////////////////////////////////////////////////////////////////////
// Section 3.3 Error Codes
#define ERROR33__FREQUENCY                                                     \
    3300 /**< Frequency must be between 10 and 100 GHz, inclusive */
#define ERROR33__THETA                                                         \
    3301 /**< Elevation angle must be between 0 and 100 GHz, inclusive */
#define ERROR33__PERCENTAGE                                                    \
